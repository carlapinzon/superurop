...
function [x_eq, gain] = LD_EEQ(x, Fs, Tfast, Tslow, useFIR, gain_bounds_dB)
...
%     gain(vad==0) = 1;
    ...
    rms_before_renormalization = rms(x_eq);
    ...
    rms_after_renormalization = rms(gain_eq.*x_eq);
    
    20*log10([rms_before_renormalization rms_after_renormalization])
